...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const studioEnrichmentResultEl = document.getElementById(
    'studio-enrichment-result'
  )
  ...
  analyzeProfileBtn.addEventListener('click', async () => {
    ...
    try {
      const result =
        await aiOrchestrationService.analyzeUserProfile('default-user')
  ...
  findJobsBtn.addEventListener('click', async () => {
    ...
    try {
      const result =
        await aiOrchestrationService.findMatchingJobs('default-user')
  ...
  enrichStudioBtn.addEventListener('click', async () => {
    ...
    try {
      const result =
        await aiOrchestrationService.enrichStudioData(sampleStudioId)
