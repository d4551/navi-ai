  ...
  try {
    ...
    if (kokoroModule.default) {
      ...
      console.log(
        ...
        DefaultKokoro.constructor.name
      )
    ...
    // Check named exports
    const namedExports = Object.keys(kokoroModule).filter(
      key => key !== 'default'
    )
      ...
      for (const exportName of namedExports) {
        ...
        if (typeof exportedItem === 'function') {
          ...
          try {
            ...
            console.log(
              `  ❌ Could not instantiate ${exportName}:`,
              error.message
            )
            ...
            try {
              ...
              console.log(
                `  📞 Called ${exportName} as function:`,
                typeof result
              )
            } catch (funcError) {
              console.log(
                `  ❌ Could not call ${exportName} as function:`,
                funcError.message
              )
            }
          }
