...
const GAMING_STUDIOS = {
  ...
  blizzard: {
    ...
    description: "Legendary game developer behind World of Warcraft and Overwatch",
    culture: {
      values: ["Gameplay First", "Commit to Quality", "Play Nice; Play Fair", "Embrace Your Inner Geek", "Every Voice Matters"],
