...
const EXPANDED_GAMING_STUDIOS = {
  "riot-games": {
    ...
    majorGames: [
      { name: "League of Legends", year: 2009, platforms: ["PC"], genre: "MOBA" },
  ...
  blizzard: {
    ...
    majorGames: [
      { name: "World of Warcraft", year: 2004, platforms: ["PC"], genre: "MMORPG" },
      { name: "Overwatch", year: 2016, platforms: ["PC", "Console"], genre: "FPS" }
    ],
    glassdoorRating: 4.0,
