...
const TOP_100_GAMING_STUDIOS = [
  ...
  },
  {
    ...
    type: "AAA Publisher",
    founded: 1993,
    description: "World's leading gaming entertainment company, PlayStation ecosystem",
    games: [
      "God of War",
      "The Last of Us",
      "Spider-Man",
  ...
  },
  {
    ...
    type: "AAA Publisher",
    founded: 1889,
    description: "Global entertainment company, creator of Mario, Zelda, Pokemon franchises",
    games: [
      "Super Mario",
      "The Legend of Zelda",
      "Pokemon",
