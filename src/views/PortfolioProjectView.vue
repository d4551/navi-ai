<template>
  <div
    class="portfolio-project page-glass-container font-sans"
    ...
    >
      <template #header-actions>
        ...
        <UnifiedButton
          ...
          >Open</UnifiedButton
        >
        <UnifiedButton variant="outline" leading-icon="ShareIcon" @click="share"
          >Share</UnifiedButton
        >
      </template>
      ...
      <section v-if="imageUrl" class="hero unified-container">
        <div
          class="hero-media glass p-glass-md gap-glass-md rounded-lg unified-card"
        >
        ...
        <div class="grid">
          ...
          <div class="flex-1 main">
            <article
              ...
              class="glass p-glass-md gap-glass-md rounded-lg unified-card is-interactive neon-hover ripple-soft"
            >
          ...
          <aside class="flex-1 side">
            <div
              class="glass p-glass-md gap-glass-md rounded-lg unified-card details"
            >
      ...
      <div v-else class="unified-container">
        <div
          class="glass p-glass-lg gap-glass-md rounded-lg unified-card empty text-center"
        >
