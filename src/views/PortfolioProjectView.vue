  ...
  <div class="portfolio-project page-glass-container" :data-theme="themeName">
    ...
    >
      ...
      <section v-if="imageUrl" class="hero unified-container">
        <div class="hero-media section-card section-card unified-card">
        ...
        <div class="grid">
          ...
          <div class="col main">
            <article
              ...
              class="section-card section-card unified-card is-interactive neon-hover ripple-soft"
            >
          ...
          <aside class="col side">
            <div class="section-card section-card unified-card details">
      ...
      <div v-else class="unified-container">
        <div class="section-card section-card unified-card empty text-center">
