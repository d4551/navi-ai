  ...
  >
    ...
    <div class="prep-layout">
      ...
      <UnifiedCard
        ...
        variant="glass"
        class="glass p-glass-md gap-glass-md rounded-lg"
      >
      ...
      >
        <div class="section-header">
          <h3 class="panel-title">
            <AppIcon name="BuildingOffice2Icon" /> Target Studio
          </h3>
        </div>
      ...
      >
        <div class="panel-header flex items-center justify-between">
          <h3 class="panel-title">
            <AppIcon name="StarIcon" /> Recommended Studios
          </h3>
        ...
        <h3 class="panel-title mt-lg">
          <AppIcon name="ClockIcon-time-nine-outline" /> Recent Presets
        </h3>
    ...
    >
      <div class="modal-card" ref="modalEl" tabindex="-1" @click.stop>
        ...
        <div class="modal-body">
          ...
          <div
            v-if="pendingPersonaSuggestion?.studioName"
            class="pv-flex flex-wrap"
          >
...
.mini-note {
  ...
  border: 1px solid
    color-mix(in srgb, var(--color-info) 20%, var(--border-base));
