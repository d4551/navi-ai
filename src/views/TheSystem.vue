  ...
  >
    ...
    <section class="controls-section section-card">
      ...
      <div class="controls-grid responsive-grid--cards-sm">
        <!-- System Power -->
        <div
          class="control-card glass p-glass-md gap-glass-md rounded-lg neon-interactive"
        >
          ...
          <div class="device-header">
            ...
            <div class="device-controls">
              <UnifiedButton
                ...
                icon-only
                :leading-icon="
                  device.status === 'active' ? 'PauseIcon' : 'PlayIcon'
                "
    ...
    <section class="analytics-section glass p-glass-md gap-glass-md rounded-lg">
      ...
      <div class="analytics-grid responsive-grid--cards-md">
        <!-- Performance Chart -->
        <div
          class="analytics-card glass p-glass-md gap-glass-md rounded-lg analytics-card--large"
        >
