      ...
      <v-window v-model="activeTab" class="prep-content">
        ...
        <v-window-item value="setup">
          <div class="setup-section">
            <v-row>
              <v-col cols="12" md="6">
                <Card variant="glass" class="setup-card">
              ...
              <v-col cols="12" md="6">
                <Card variant="glass" class="profile-card">
                  <div class="card-header mb-4">
          ...
          <div class="mock-interview-section">
            ...
            <div v-else class="active-interview">
              ...
              <div class="interview-content">
                <Card variant="glass" class="current-question-card mb-4">
                ...
                <!-- Response Recording -->
                <Card variant="glass" class="response-recording-card">
        ...
        <v-window-item value="feedback">
          <div class="feedback-section">
            ...
            <div v-else class="feedback-content">
              ...
              <Card variant="glass" class="performance-overview mb-4">
                <div class="card-header mb-4">
              ...
              <!-- Recent Interviews -->
              <Card variant="glass" class="recent-interviews">
                <div
                ...
                <div class="interviews-list">
                  ...
                  >
                    <div class="interview-info">
                      ...
                      >
                        {{ formatDateBasic(interview.date) }} •
...
interface InterviewRecord { id: string; role: string; company: string; date: Date; duration: number; questionsAnswered: number; score: number }
...
const mockInterviewQuestions = ref<QuestionItem[]>([]);
...
const filteredQuestions = computed(() => {
  ...
  return generatedQuestions.value.filter(
    (q) => q.category === String(questionFilter.value),
  );
});
...
const endInterview = () => {
  ...
  interviewHistory.value.unshift(interviewRecord as InterviewRecord);
...
const getPriorityVariant = (priority: PriorityLevel): string => {
...
const getDifficultyVariant = (difficulty: DifficultyLevel): string => {
