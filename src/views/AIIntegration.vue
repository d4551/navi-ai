<template>
  ...
  >
    ...
    <div class="ai-integration-header section-card">
    ...
    <div class="ai-status-section section-card">
      ...
      <div class="service-actions">
        ...
        <UnifiedButton variant="ghost" icon="mdi-cog" @click="openSettings">
          Configure Services
        </UnifiedButton>
      </div>
    </div>
    ...
    <div class="ai-capabilities-section section-card">
    ...
    <!-- AI Action Center -->
    <div class="ai-actions-section section-card">
