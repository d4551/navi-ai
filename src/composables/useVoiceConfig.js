...
function fixInvalidSettings() {
  ...
  if (
    ...
    voiceSettings.value.speechRate < 0.5 ||
    voiceSettings.value.speechRate > 2
  ) {
  ...
  if (
    ...
    voiceSettings.value.speechPitch < 0.5 ||
    voiceSettings.value.speechPitch > 2
  ) {
  ...
  if (
    ...
    voiceSettings.value.speechVolume < 0 ||
    voiceSettings.value.speechVolume > 1
  ) {
