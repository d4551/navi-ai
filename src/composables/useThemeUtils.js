...
export function createUtilityClasses() {
  return {
    spacing: Object.fromEntries(
      Object.entries({"xs":"0.25rem","sm":"0.5rem","md":"1rem","lg":"1.5rem","xl":"2rem","2xl":"3rem"}).map(([key, value]) => [
        `glass-${key}`,
    ...
    borderRadius: Object.fromEntries(
      Object.entries({"sm":"0.25rem","md":"0.375rem","lg":"0.5rem","xl":"0.625rem"}).map(([key, value]) => [
        `rounded-glass-${key}`,
        `border-radius: ${value};`
      ])
    )
