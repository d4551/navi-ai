...
console.log('✅ Basic emit/on:', testResult === 'Received: Hello World' ? 'PASS' : 'FAIL');
...
emitter.on('count-test', () => {});
console.log('✅ Listener count:', emitter.listenerCount('count-test') === 2 ? 'PASS' : 'FAIL');

// Test 5: Event names
const eventNames = emitter.eventNames();
console.log('✅ Event names:', eventNames.includes('test') && eventNames.includes('count-test') ? 'PASS' : 'FAIL');
