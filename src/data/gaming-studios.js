...
export const GAMING_STUDIOS = [
  // Tier 1 - AAA Studios and Major Publishers
  {
    ...
    name: 'Riot Games',
    description:
      'Creators of League of Legends and VALORANT, focused on player-focused game experiences',
...

  {
    ...
    description:
      'One of the largest video game publishers, known for FIFA, The Sims, and Battlefield franchises',
...

  {
    ...
    description:
      'Publisher of Call of Duty, World of Warcraft, Overwatch, and mobile gaming leader',
...

  {
    ...
    description:
      "French multinational developer of Assassin's Creed, Rainbow Six, and Far Cry franchises",
...

  {
    ...
    name: 'Epic Games',
    description:
      'Creator of Fortnite and Unreal Engine, pioneering metaverse experiences',
    location: 'Cary, NC',
  ...
  // Tier 2 - Mid-size and Specialized Studios
  {
    ...
    name: 'Naughty Dog',
    description:
      'Acclaimed studio behind The Last of Us and Uncharted, masters of narrative-driven games',
    location: 'Santa Monica, CA',
    headquarters: 'Santa Monica, CA',
...

  {
    ...
    name: 'CD Projekt RED',
    description:
      'Polish developer of The Witcher series and Cyberpunk 2077, known for ambitious RPGs',
...

  {
    ...
    description:
      'Studio behind Titanfall, Apex Legends, and Star Wars Jedi series',
    location: 'Los Angeles, CA',
    headquarters: 'Los Angeles, CA',
  ...
  // Gaming Technology & Platform Companies
  {
    ...
    description:
      'Creator of Steam platform, Half-Life, Portal, and pioneers in VR with Steam Deck',
...

  {
    ...
    description:
      'Leading game engine provider empowering millions of creators worldwide',
  ...
  // Mobile Gaming Leaders
  {
    ...
    name: 'Supercell',
    description:
      'Finnish mobile game company behind Clash of Clans, Clash Royale, and Brawl Stars',
...

  {
    ...
    name: 'King',
    description:
      'Mobile gaming giant behind Candy Crush Saga and other casual gaming hits',
    location: 'London, UK',
  ...
  // Emerging and Indie Studios
  {
    ...
    description:
      'Chinese developer of Genshin Impact and Honkai series, leading in anime-style games',
...

  {
    ...
    name: 'Larian Studios',
    description:
      "Belgian RPG specialists behind Baldur's Gate 3 and Divinity series",
...

  {
    ...
    name: 'FromSoftware',
    description:
      'Japanese developer renowned for Dark Souls, Elden Ring, and challenging action RPGs',
...

  {
    ...
    name: 'Rockstar Games',
    description:
      'Creator of Grand Theft Auto and Red Dead series, masters of open-world gaming',
...

  {
    ...
    name: 'Bungie',
    description:
      'Creators of Halo and Destiny franchises, pioneers in shared-world shooters',
    location: 'Bellevue, WA',
    headquarters: 'Bellevue, WA',
    ...
    stockTicker: null,
    parentCompany: 'Sony Interactive Entertainment',
    games: ['Destiny 2', 'Destiny', 'Halo series (legacy)', 'Marathon series'],
    specialties: [
...

  {
    ...
    description:
      "Hideo Kojima's independent studio behind Death Stranding and innovative gaming experiences",
    location: 'Tokyo, Japan',
    headquarters: 'Tokyo, Japan',
    ...
    stockTicker: null,
    parentCompany: null,
    games: ['Death Stranding', "Death Stranding Director's Cut"],
    specialties: [
      'Innovative Gameplay',
      'Narrative Design',
...

  {
    ...
    description:
      'Creators of Spider-Man, Ratchet & Clank, and innovative PlayStation exclusives',
    location: 'Burbank, CA',
...

  {
    ...
    description:
      'RPG specialists behind Pillars of Eternity, The Outer Worlds, and narrative-driven games',
    location: 'Irvine, CA',
...

  {
    ...
    description:
      'Finnish studio behind Max Payne, Alan Wake, and innovative narrative action games',
  ...
  // Indie and Rising Studios
  {
    ...
    description:
      'Independent studio focused on innovative gameplay mechanics and artistic expression',
    location: 'Remote',
    ...
    stockTicker: null,
    parentCompany: null,
    games: ['I Am Dead', "Wilmot's Warehouse", 'Various experimental projects'],
    specialties: [
...

  {
    ...
    description:
      'Global services provider for the video game industry, specializing in QA, localization, and more',
