...
export const experienceSchema = z.object({
  ...
  achievements: z.array(z.string()
    .max(200, 'Each achievement cannot exceed 200 characters'))
...
export const educationSchema = z.object({
  ...
  startDate: z.string()
    .regex(/^\d{4}$/, 'Invalid start year format'),
...
export const jobSearchSchema = z.object({
  ...
  locations: z.array(z.string()
    .max(100, 'Each location cannot exceed 100 characters'))
...
export const fileUploadSchema = z.object({
  ...
  type: z.string()
    .regex(/^(application|image|text)\//, 'Invalid file type'),
...
export const portfolioItemSchema = z.object({
  ...
  technologies: z.array(z.string()
    .max(30, 'Technology name cannot exceed 30 characters'))
