...
export class DatabaseService {
  ...
  async initialize(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      const request = (indexedDB as any).open(this.config.name, this.config.version);
  ...
  async findById<T extends BaseEntity>(
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () =>
        reject(new Error(`Failed to find entity: ${request.error}`));
    });
  }
  ...
  async findByIndex<T extends BaseEntity>(
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () =>
        reject(new Error(`Failed to find entities: ${request.error}`));
    });
  }
  ...
  async count(storeName: string): Promise<number> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () =>
        reject(new Error(`Failed to count entities: ${request.error}`));
    });
  }
  ...
  async findUserByEmail(email: string): Promise<UserProfile | null> {
    const users = await this.findByIndex<UserProfile>("users", "email", email, {
    });
  }
  ...
  async findJobApplicationsByStatus(
  ...
  async clearAllData(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      storeNames.forEach((storeName) => {
        ...
        request.onerror = () => {
          reject(
            new Error(`Failed to clear store ${storeName}: ${request.error}`),
          );
        };
      });
    });
