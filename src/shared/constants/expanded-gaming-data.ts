    ...
    jobOpenings: [
      {
        ...
        remote: false,
        requirements: [
          '7+ years 3D art experience',
          'Maya/3ds Max proficiency',
          'Game art pipeline',
        ],
    ...
    jobOpenings: [
      {
        ...
        requirements: [
          '3+ years mobile game design',
          'F2P/LiveOps experience',
          'Data analysis',
        ],
        skills: [
          'Game Design',
