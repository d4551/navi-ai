  ...
  describe('Actions', () => {
    describe('updateUser', () => {
      it('updates user profile successfully', () => {
        ...
        expect(userStore.user.personalInfo.email).toBe(testUser.personalInfo.email);
      });
      ...
      it('updates last modified timestamp', () => {
        ...
        expect(new Date(userStore.user.meta.lastUpdated!).getTime())
    ...
    describe('specific update methods', () => {
      it('updates personal info correctly', () => {
        ...
        expect(result).toBe(true);
        expect(userStore.user.personalInfo).toEqual(expect.objectContaining(personalInfo));
      });
