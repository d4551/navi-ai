...
describe('Test Helpers', () => {
  ...
  describe('ComponentTestHelper', () => {
    ...
    it('triggers events and waits for updates', async () => {
      ...
      await ComponentTestHelper.triggerAndWait(wrapper, 'click', '[data-test="test-button"]');
  ...
  describe('Integration Tests', () => {
    it('combines multiple helpers for complete testing', async () => {
      ...
      await ComponentTestHelper.triggerAndWait(wrapper, 'click', '[data-test="load-button"]');
      ...
      // Test timing
      const searchInput = ComponentTestHelper.findByTestId(wrapper, 'search-input');
