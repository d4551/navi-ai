            ...
            <div class="rec-meta">
              ...
              <div class="rec-stats">
                <span class="match-percentage"
                  >{{ aiRecommendations.skillMatch }}%</span
                >
        ...
        >
          <div class="recommendation-header">
            ...
            <div class="rec-meta">
              ...
              <div class="rec-stats">
                <span class="match-percentage"
                  >+{{ aiRecommendations.salaryIncrease }}%</span
                >
          ...
          <div class="recommendation-header">
            <div class="rec-icon-wrapper">
              <AppIcon
                ...
                class="rec-icon text-primary-600"
              />
            </div>
            <div class="rec-meta">
            ...
            <div class="role-chips">
              ...
              >
                ...
                <span
                  ...
                  ><AppIcon name="FireIcon" size="small" color="warning"
                /></span>
                <span
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="view-options">
            <UnifiedButton
              variant="glass"
              size="sm"
              leading-icon="Bars3BottomLeftIcon"
