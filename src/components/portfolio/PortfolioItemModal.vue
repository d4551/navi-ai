      ...
      <div class="modal-content elevated">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-3">
              ...
              <select v-model="formData.type" class="form-select" required>
                ...
                <option value="clip">
                  <AppIcon name="VideoCameraIcon" size="small" /> Video Clip
                </option>
                ...
                <option value="content">
                  <AppIcon name="VideoCameraIcon" size="small" /> Content
                  Creation
                </option>
                <option value="project">
                  <AppIcon name="FolderIcon" size="small" /> Project
                </option>
                <option value="stream">
                ...
                <option value="collaboration">
                  <AppIcon name="UsersIcon" size="small" /> Collaboration
                </option>
              </select>
            </div>
        ...
        <div class="modal-footer">
          ...
          <UnifiedButton
            ...
            @click="handleSubmit"
            >{{ isEditing ? 'Update' : 'Add' }} Item</UnifiedButton
          >
        </div>
      </div>
    </div>
