<template>
  <div v-if="show" class="modal-overlay font-sans" @click="handleOverlayClick">
        ...
        <div class="header-actions flex items-center gap-glass-sm">
          ...
          <div class="btn-group" role="group">
            <input
              ...
              value="formatted"
            />
            <label for="view-formatted" class="btn btn-outline-primary btn-sm"
              >Formatted</label
            >
            ...
            <input
              ...
              value="raw"
            />
            <label for="view-raw" class="btn btn-outline-primary btn-sm"
              >Raw Text</label
            >
          </div>
