  ...
  >
    ...
    <div class="card-body section-body card-body--dense">
      <form novalidate @submit.prevent="$emit('save-settings')">
        <!-- API Key Section -->
        <div
          class="api-key-section mb-4 p-glass-md border rounded-3 glass-input"
        >
          ...
          <div class="mb-3">
            <label for="gemini-api-key" class="form-label font-medium"
            ...
            <div id="api-key-help" class="form-text api-key-hint">
              <span class="hint-prefix" aria-hidden="true"
                ><KeyIconComponent class="mr-1 icon-xs"
              /></span>
        ...
        <!-- AI Model Section -->
        <div
          class="ai-model-section mb-4 p-glass-md border rounded-3 glass-input"
        >
          <div class="flex items-center mb-3">
          ...
          <div class="mb-3">
            <label for="ai-model" class="form-label font-medium"
              >Select Model</label
            >
        ...
        <div
          class="voice-audio-section mb-4 p-glass-md border rounded-3 glass-input"
        >
          <div class="flex items-center mb-3">
            <SoundwaveIconComponent class="mr-2 text-primary-600" />
            <h6 class="mb-0 text-primary-600 font-bold">
          ...
          <div class="flex flex-wrap g-3 mb-3">
            <div class="flex-1-md-6">
              <div class="p-glass-md border rounded-3 glass-subtle">
                <label class="form-label font-medium mb-2"
                  >Text-to-Speech Engine</label
                >
                <div class="flex flex-flex-1 gap-glass-sm">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="tts-gemini">
                      ...
                      <br /><small class="text-secondary"
                        >Natural AI voice (requires API key)</small
                      >
                    </label>
                  </div>
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="tts-kokoro">
                      ...
                      <br /><small class="text-secondary"
                        >Local neural voice models (offline)</small
                      >
                    </label>
                  </div>
                </div>
                ...
                <div class="flex flex-flex-1 gap-glass-sm">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="stt-gemini">
                      ...
                      <br /><small class="text-secondary"
                        >Cloud transcription (requires API key)</small
                      >
                    </label>
                  </div>
                </div>
          ...
          <div class="flex flex-wrap g-3">
            <div class="flex-1-lg-6">
              ...
              <div id="microphone-help" class="form-text hint-chip" role="note">
                <MicIconComponent />
                <span
                  >Select your preferred microphone for voice input and
