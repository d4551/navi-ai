<template>
  <nav
    class="navigation-menu glass-surface text-glass-primary font-sans"
    :class="[
      {
  ...
  >
    ...
    <div
      class="nav-brand glass-strong p-glass-md rounded-lg glass-bg border border-glass-border"
    >
      <router-link
        to="/"
      ...
      <div
        class="nav-controls flex items-center gap-glass-sm p-glass-sm"
    ...
    >
      <div class="nav-items nav-items-flat">
        ...
        />
        <div
          class="nav-divider border-glass-border dark:border-glass-border dark:border-glass-border"
          role="separator"
          aria-hidden="true"
        ></div>
        <NavigationItem
    ...
    <!-- Redesigned Footer -->
    <div
      class="nav-footer glass-footer bg-glass-bg/80 dark:bg-gray-800/80 border-t border-glass-border dark:border-glass-border dark:border-glass-border"
      :class="{ collapsed: isCollapsed }"
    >
    ...
    >
      ...
      >
        ...
        <div class="nav-search-results">
          ...
          >
            <AppIcon
              :name="res.icon?.replace('mdi ', '') || 'Bars3Icon-right'"
              size="inherit"
            />
            <div class="res-main">
