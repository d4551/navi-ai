<template>
  <div class="glass-card font-sans">
    ...
    <header
      v-if="showHeader"
      class="flex items-center justify-between p-glass-lg border-b border-glass-border"
    >
      ...
      <div
        ...
        class="flex items-center space-x-glass-sm"
      >
    ...
    <main class="p-glass-lg space-y-glass-md">
      ...
      <div v-if="loading" class="flex items-center justify-center py-glass-xl">
        <div
          class="animate-spin rounded-full h-8 w-8 border-2 border-neon-blue border-opacity-25 border-t-neon-blue"
        ></div>
      ...
      <div
        v-else-if="error"
        class="bg-error-50 border border-error-200 rounded-md p-glass-md"
      >
    ...
    <footer
      ...
      class="flex items-center justify-end p-glass-lg border-t border-glass-border space-x-glass-sm"
    >
      <slot name="footer">
        <button
