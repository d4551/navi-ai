  ...
  >
    ...
    <div v-if="isLoading" class="skeleton-container" role="status" aria-live="polite">
      ...
      <template v-if="variant === 'table'">
        <div class="skeleton-table">
          ...
          <div v-for="n in rowCount" :key="`flex flex-wrap-${n}`" class="skeleton-table-flex flex-wrap">
    ...
    <div v-if="hasError && !isLoading" class="error-state" role="alert">
      <div class="error-icon">
        <AppIcon name="ExclamationCircleIcon" size="large" />
      </div>
...
.skeleton-table-flex flex-wrap:last-child {
  border-b: none;
}
