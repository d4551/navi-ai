...
export { default as UnifiedCard } from '../UnifiedCard.vue';
...
export const MuiComponents = {
  ...
  ElevatedCard: createMuiComponent(UnifiedCard, {
    variant: 'elevated',
    elevation: 'medium',
    size: 'md'
  }),
  
  OutlinedCard: createMuiComponent(UnifiedCard, {
    variant: 'default',
    elevation: 'none',
    size: 'md'
  }),
  
  GlassCard: createMuiComponent(UnifiedCard, {
    variant: 'glass',
    elevation: 'low',
    size: 'md'
  }),
...
export const integrateWithServices = (serviceRegistry: any) => ({
  ...
  createServiceBoundComponent: (componentName: string, serviceName: string) => ({
...
export type MuiComponentColor = 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info';
