      ...
      <transition name="indicator-appear">
        ...
        >
          <div class="indicator-icon">
            <AppIcon
              :name="getIcon('MicrophoneIcon', 'MicrophoneIcon')"
              :size="getIconSize()"
              :color="getIconColor()"
            />
          </div>
      ...
      >
          ...
          <div class="message message-ai">
            ...
            <div class="message-content">
              <div class="message-bubble">
                Hi! I'm NAVI, your AI career fairy! SparklesIcon I can help with
                resumes, job searches, interviews, and more. What would you like
                to work on today?
              </div>
        ...
        <div class="quick-replies">
          ...
          <button class="quick-reply">
            DevicePhoneMobileIcon Gaming Skills
          </button>
        </div>
        ...
        <div class="chat-input-container">
          ...
          <div class="primary-input-area">
            ...
            <div class="input-actions">
              <button class="control-btn" title="Upload file">
                PaperClipIcon
              </button>
          ...
          <div class="secondary-controls">
            <div class="control-group media-controls">
              ...
              <button class="control-btn" title="Voice input">
                MicrophoneIcon
              </button>
              <button class="control-btn" title="Video call">
                VideoCameraIcon
              </button>
              <button class="control-btn" title="Screen capture">📸</button>
            </div>
            <div class="control-group ai-controls">
              <button class="control-btn" title="AI suggestions">
                SparklesIcon
              </button>
            </div>
          </div>
      ...
      >
        <div class="camera-header">
          ...
          <button class="glass-btn" @click="closeCameraModal">
            <AppIcon
              :name="getIcon('XMarkIcon', 'XMarkIcon')"
              :size="getIconSize()"
            />
          </button>
        </div>
        <div class="camera-content">
          ...
          <div class="camera-controls">
            <button class="glass-btn ai-powered" @click="captureImage">
              <AppIcon
                :name="getIcon('CameraIcon', 'CameraIcon')"
                :size="getIconSize()"
              />
              Capture & Analyze
            </button>
          ...
          <div class="settings-flex flex-wrap">
            ...
            >
              <AppIcon
                :name="
                  isSpeaking
                    ? getIcon('StopIcon', 'StopIcon')
                    : getIcon('PlayIcon', 'PlayIcon')
                "
                :size="getIconSize()"
              />
          ...
          <div class="settings-info">
            <small class="provider-info">
              <AppIcon
                :name="
                  getIcon(
                    'InformationCircleIconrmation-outline',
                    'InformationCircleIconrmation-outline'
                  )
                "
                :size="getIconSize()"
    ...
    async function sendMessage() {
      ...
      try {
        ...
        if (error.message.includes('API key')) {
          ...
          errorResponse =
            "I've reached my usage limit for now. Please try again later! ClockIcon"
        }
...
.skeleton-line {
  ...
  background: linear-gradient(
    ...
    color-mix(
        in srgb,
        var(--glass-bg-glass-bg dark: bg-glass-bg-hover) 90%,
        transparent
      )
      0%,
