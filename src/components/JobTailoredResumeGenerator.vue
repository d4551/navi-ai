<template>
  <div class="job-tailored-resume-generator font-sans">
    ...
    <div class="generator-header mb-6">
      <h2 class="h2 text-gradient-gaming mb-2">AI-Powered Resume Tailoring</h2>
      <p class="text-secondary mb-4">
        Paste a job posting or URL to generate a tailored resume and cover
        letter optimized for ATS systems
      </p>
    </div>
    ...
    <div class="surface-elevated border-subtle rounded-xl mb-6">
      ...
      <div class="p-glass-md">
        ...
        <div v-if="hasJobAnalysis" class="job-analysis-results mt-4">
          <div
            class="surface-success-subtle border-success-subtle rounded-lg p-glass-md mb-4"
          >
            <AppIcon name="CheckCircleIcon" color="success" class="mr-2" />
            <span class="text-success-600-emphasis"
              >Job analysis completed! Ready to tailor your resume.</span
            >
          </div>
          ...
          <div class="flex flex-wrap">
            <div class="flex-1-md-6 mb-3">
              <div
                class="surface-elevated border-subtle rounded-lg p-glass-md h-100"
              >
                ...
                <p v-if="jobAnalysis.location">
                  <strong>Location:</strong> {{ jobAnalysis.location }}
                </p>
              </div>
            </div>
            ...
            <v-expansion-panel>
              ...
              <v-expansion-panel-text>
                <div class="company-insights">
                  ...
                  <div
                    v-if="jobAnalysis.growthOpportunities.length"
                    class="mb-3"
                  >
                    <h5>Growth Opportunities</h5>
                    <ul>
                      <li
                        v-for="opp in jobAnalysis.growthOpportunities"
                        :key="opp"
                      >
                        {{ opp }}
                      </li>
                  ...
                  <div v-if="jobAnalysis.uniqueSellingPoints.length">
                    ...
                    <ul>
                      <li
                        v-for="point in jobAnalysis.uniqueSellingPoints"
                        :key="point"
                      >
                        {{ point }}
                      </li>
    ...
    <div
      class="surface-elevated border-subtle rounded-xl mb-6"
      :class="{ disabled: !hasJobAnalysis }"
    >
      <div class="p-glass-md border-b border-subtle">
        <div class="flex items-center gap-glass-md">
        ...
        <div v-else>
          ...
          <div v-if="hasTailoredResume" class="tailoring-results mt-4">
            ...
            <div class="flex flex-wrap mb-4">
              ...
              <div class="flex-1-md-3 mb-2">
                <div class="score-card">
                  <div
                    class="score-value"
                    :class="getScoreColor(keywordCoverage)"
                  >
                    {{ keywordCoverage }}%
                  </div>
                  ...
                  <v-expansion-panel-title>
                    <div class="flex items-center justify-between w-100">
                      <span class="text-capitalize"
                        >{{ section.type }} Section</span
                      >
                      <div class="flex items-center gap-glass-sm">
                        <span
                          class="score-badge"
                          :class="getScoreColor(section.atsScore)"
                        >
                          {{ section.atsScore }}%
                        </span>
                        ...
                        <div class="flex flex-wrap">
                          <div class="flex-1-md-6">
                            ...
                            <div class="content-preview original">
                              <pre>{{
                                formatContent(section.originalContent)
                              }}</pre>
                            </div>
                          </div>
                          <div class="flex-1-md-6">
                            ...
                            <div class="content-preview tailored">
                              <pre>{{
                                formatContent(section.tailoredContent)
                              }}</pre>
                            </div>
                          </div>
                        </div>
            ...
            <div v-if="tailoredResume?.recommendations" class="recommendations">
              ...
              <div class="flex flex-wrap">
                <div
                  v-if="tailoredResume.recommendations.criticalChanges.length"
                  class="flex-1-md-6"
                >
                  <div class="recommendation-card critical">
                    ...
                    <ul>
                      <li
                        v-for="change in tailoredResume.recommendations
                          .criticalChanges"
                        :key="change"
                      >
                        {{ change }}
                ...
                <div
                  v-if="
                    tailoredResume.recommendations.suggestedImprovements.length
                  "
                  class="flex-1-md-6"
                >
                  <div class="recommendation-card suggested">
                    ...
                    <ul>
                      <li
                        v-for="improvement in tailoredResume.recommendations
              ...
              <div
                v-if="tailoredResume.recommendations.missingKeywords.length"
                class="mt-3"
              >
                <h5>Missing Keywords to Consider:</h5>
                <div class="missing-keywords">
                  <span
                    v-for="keyword in tailoredResume.recommendations
                      .missingKeywords"
                    :key="keyword"
    ...
    <div class="card-unified" :class="{ disabled: !hasJobAnalysis }">
      ...
      <div class="card-body section-body">
        ...
        <div v-else>
          ...
          <div
            v-if="coverLetterComposable.hasGeneratedContent.value"
            class="mt-4"
          >
...
async function tailorResume() {
  if (!currentResume.value) {
    toast.error(
      'No resume data available. Please create or load a resume first.'
    )
    return
  }
