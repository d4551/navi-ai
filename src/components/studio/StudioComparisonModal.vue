        ...
        <div class="comparison-grid">
          ...
          >
            ...
            <div class="data-item">
              ...
              <span class="data-value">{{
                (studio as any).type || (studio as any).category || 'Unknown'
              }}</span>
            </div>
          </div>
          ...
          >
            <div v-if="studio.games?.length" class="games-list">
              <div
                v-for="game in studio.games.slice(0, 5)"
                :key="game"
                class="game-tag"
              >
                {{ game }}
            ...
            <div v-else class="no-data">No games listed</div>
          </div>
          ...
          >
            <div v-if="studio.technologies?.length" class="tech-list">
              <div
                v-for="tech in studio.technologies.slice(0, 6)"
                :key="tech"
                class="tech-tag"
              >
                {{ tech }}
            ...
            <div v-else class="no-data">No tech stack listed</div>
          </div>
            ...
            <div v-if="studio.culture?.values?.length" class="culture-info">
              <div class="culture-subsection">
                ...
                <div class="values-list">
                  <span
                    v-for="value in studio.culture.values.slice(0, 3)"
                    :key="value"
                    class="value-tag"
                  >
                    {{ value }}
                  ...
                  <span
                    v-if="studio.culture.values.length > 3"
                    class="more-count"
                  >
              ...
              <div v-if="studio.culture.workStyle" class="culture-subsection">
                ...
                <p class="culture-text">
                  {{ truncateText(studio.culture.workStyle, 100) }}
                </p>
              </div>
            </div>
            <div v-else class="no-data">No culture info available</div>
          </div>
          ...
          >
            <div v-if="studio.commonRoles?.length" class="roles-list">
              <div
                v-for="role in studio.commonRoles.slice(0, 4)"
                :key="role"
                class="role-tag"
              >
                {{ role }}
            ...
            <div v-else class="no-data">No roles listed</div>
          </div>
        </div>
      </div>
...
.comparison-category {
  ...
  border-radius: var(--radius-md);
  border: 1px solid
    color-mix(in srgb, var(--color-primary-500) 20%, var(--glass-border));
}
