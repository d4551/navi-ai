                          ...
                          <div class="flex items-start">
                            <div class="flex-grow-1">
                              <div class="flex items-center mb-2">
                                <span
                                  :class="`badge mr-2 ${getBadgeClass(suggestion.type)}`"
                ...
                >
                  <div class="analysis-section">
                    ...
                    >
                      ...
                      >
                        <AppIcon
                          name="CheckIcon-circle-outline-outline"
                          class="mr-2"
                        />
                    ...
                    <div v-if="isProcessing" class="text-center py-4">
                      <AppIcon
                        name="CpuChipIcon"
                        class="spin mdi-48px mb-3 text-primary-600"
                      />
                        ...
                        >
                          ...
                          >
                            <div class="message-content">
                              ...
                              <small class="text-secondary message-timestamp">{{
...
const getPriorityCardClass = (priority: string): string => {
  switch (priority) {
    ...
    case 'urgent':
      return 'border-danger bg-glass-bg dark:bg-glass-bg-hover-danger'
    default:
