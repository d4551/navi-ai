<template>
  <Teleport to="body">
    <div
      v-if="open"
      class="fairy-modal-overlay bg-glass-bg dark:bg-glass-bg/50 dark:bg-glass-bg dark:bg-glass-bg/70"
      @click.self="close"
    >
      <div
        :class="[
      ...
      >
        <div
          class="fairy-chat-interface glass-panel glass-panel--compact bg-glass-bg/95 dark:bg-gray-800/95"
        ...
        >
          ...
          <!-- Header -->
          <div
            class="chat-header modern-header glass-bg-glass-bg dark:bg-glass-bg-hover/50 border-b border-glass-border dark:border-glass-border dark:border-glass-border"
            role="heading"
            aria-level="2"
          >
          ...
          <!-- Input -->
          <div
            class="chat-input-container enhanced-input-container glass-footer glass-bg-glass-bg dark:bg-glass-bg-hover/50 border-t border-glass-border dark:border-glass-border dark:border-glass-border"
            role="group"
            ...
            <div class="multimodal-controls enhanced-controls">
              <div class="control-group voice-controls">
                ...
                <IconButton
                  ...
                  size="sm"
                  :icon="
                    listening ? 'MicrophoneIcon' : 'MicrophoneIcon-outline'
                  "
    ...
    suggestions.push(
      {
        id: 'explore-more',
        text: 'Tell me more',
        icon: 'InformationCircleIconrmation',
      },
