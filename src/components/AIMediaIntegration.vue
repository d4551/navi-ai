<template>
  <div class="ai-media-integration unified-container font-sans">
...
const updateAnalysisRate = () => {
  ...
  try {
    const val = Math.max(1, Math.min(30, Math.round(Number(analysisFPS.value))))
...
<style scoped>
/* AI Media Integration - Enhanced Layout System */
...
.connection-status.connected .pulse-ring {
  /* Use .position-absolute and .left-neg-1 utility classes from design system */
  width: 16px;
  height: 16px;
