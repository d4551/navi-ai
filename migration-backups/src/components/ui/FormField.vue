<template>
  <div class="unified-form-field text-glass-primary" :class="{ required, valid: isValid, error: hasError }">
...
const fieldClasses = computed(() => [
  ...
  'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-glass-primary placeholder-gray-500 dark:placeholder-gray-400',
