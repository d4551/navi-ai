            ...
            <div v-if="matchData" class="match-analysis">
              <div class="mb-4">
                ...
                <div class="salary-fit-badge mb-3">
                  <UiChip
                    :classes="`chip chip-${getSalaryFitColor(matchData.salaryFit)} chip-compact`"
                  >
          ...
          <v-tabs-window-item value="insights">
            <div v-if="insightsData" class="career-insights">
              ...
              <div class="insight-section mb-4">
                ...
                <UiChip
                  :classes="`chip chip-${getComplexityColor(insightsData.jobComplexity)}`"
                >
              ...
              <div class="insight-section mb-4">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="skills-list">
                      <UiChip
                        v-for="skill in insightsData.nicetohaveSkills.slice(
                          0,
                          5
                        )"
                        :key="skill"
              ...
              <div class="insight-section">
                ...
                <UiChip
                  :classes="`chip chip-${getGrowthColor(insightsData.industryGrowth)}`"
                >
                  <AppIcon
                    :name="getGrowthIcon(insightsData.industryGrowth)"
                    class="me-2"
                  />
            ...
            <div class="market-insights">
              <div v-if="marketData">
                          ...
                          >
                            <div>
                              ...
                              <div class="text-h6 text-primary">
                                ${marketData.salaryRange.min}k -
                                ${marketData.salaryRange.max}k
                              </div>
                            </div>
                            <AppIcon
                              name="mdi-cash"
                ...
                <div class="skill-demand mb-6">
                  ...
                  <div class="skills-trending">
                    <div
                      v-for="skill in marketData.trendingSkills"
                      :key="skill.name"
                      class="skill-trend-item mb-2"
                    >
                      <div
                        class="d-flex justify-content-between align-items-center"
                      >
                      ...
                      <div class="insight-card">
                        ...
                        <div class="d-flex align-items-center">
                          <v-progress-circular
                            ...
                            :color="
                              getNumericGrowthColor(marketData.growthOutlook)
                            "
                            size="40"
                            width="4"
                          >
                          ...
                          <div class="ml-3">
                            ...
                            <div class="text-body-2">
                              {{
                                getGrowthDescription(marketData.growthOutlook)
                              }}
                            </div>
                          </div>
                        </div>
              ...
              <div v-else class="text-center py-8">
                ...
                <p class="text-body-2 text-medium-emphasis mt-3">
                  Get detailed market analysis and skill demand trends for this
                  role
                </p>
              </div>
            </div>
...
const analyzeAnotherMode = () => {
  const modes: ('match' | 'salary' | 'insights')[] = [
    'match',
    'salary',
    'insights',
  ]
...
const generateMarketData = job => {
  ...
  else if (jobTitle.includes('designer') || jobTitle.includes('artist'))
  ...
  const industryKey =
    Object.keys(industryMultipliers).find(
      ind =>
...
const determineExperienceLevel = job => {
  ...
  if (
    desc.includes('8+ year') ||
    desc.includes('staff') ||
    desc.includes('principal')
  )
    return 'staff'
  if (desc.includes('director') || desc.includes('management'))
    return 'director'
...
const determineCompetitionLevel = job => {
  ...
  if (
    ...
    job.location?.toLowerCase().includes('seattle')
  )
    return 'high'
...
const generateSmartRecommendations = (job, salaryMin, salaryMax) => {
  ...
  if (
    ...
    recommendations.push({
      ...
      description:
        'Modern frontend frameworks are highly valued. Consider deepening your expertise.',
      priority: 'high',
    })
  }
  ...
  if (
    ...
    recommendations.push({
      ...
      description:
        'Senior roles value mentorship and technical leadership skills.',
      priority: 'medium',
    })
  }
  ...
  if (description.includes('gaming') || description.includes('game')) {
    recommendations.push({
      ...
      description:
        'Portfolio should showcase game projects and engine experience.',
      priority: 'high',
    })
  }
    ...
    : [
        {
          ...
          description:
            'Research company culture and growth trajectory before applying.',
          priority: 'medium',
        },
      ]
}
