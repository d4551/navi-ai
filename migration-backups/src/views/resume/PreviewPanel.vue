              ...
              <div class="cover-inner">
                ...
                >
                  <span v-if="resume?.personalInfo?.email"
                    ><AppIcon name="mdi-email" class="me-1" />{{
                      resume.personalInfo.email
                    }}</span
                  >
                  <span v-if="resume?.personalInfo?.phone"
                    ><AppIcon name="mdi-phone" class="me-1" />{{
                  ...
                  <span v-if="resume?.personalInfo?.linkedIn"
                    ><AppIcon name="mdi-linkedin" class="me-1" />LinkedIn</span
                  >
                  <span v-if="resume?.personalInfo?.portfolio"
                    ><AppIcon name="mdi-web" class="me-1" />Portfolio</span
                  >
                </div>
              </div>
...
.cover-name {
  ...
  background: linear-gradient(
    90deg,
    var(--section-color),
    color-mix(in srgb, var(--section-color) 60%, var(--text-primary))
  );
