<template>
  ...
  >
    ...
    <div class="content-wrapper">
      ...
      <section id="gamification-section" class="section-glass" aria-labelledby="gamification-heading">
        ...
        <div v-else class="card-gaming">
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h1 class="text-sm text-secondary font-medium">Level {{ userLevel }}</h1>
          ...
          <div class="gamification-progress">
            <div class="xp-bar">
              ...
              <div class="xp-text text-glass-secondary">{{ currentXP }} / {{ requiredXP }} XP</div>
            </div>
      ...
      <section aria-labelledby="quick-actions">
        ...
        <div v-else class="grid-actions">
          <UnifiedCard variant="glass" class="glass-card glass-interactive neon-blue focus:ring-neon">
            <div class="action-content">
              ...
              <div class="action-text">
                ...
                <p class="text-glass-secondary">AI-powered resume optimization for gaming roles</p>
              </div>
              <UnifiedButton
                variant="primary"
                size="sm"
          ...
          <UnifiedCard variant="glass" class="glass-card glass-interactive neon-green focus:ring-neon">
            <div class="action-content">
              <div class="action-icon-wrapper">
              ...
              <div class="action-text">
                ...
                <p class="text-glass-secondary">Find gaming industry opportunities worldwide</p>
              </div>
              <UnifiedButton
                variant="primary"
                size="sm"
